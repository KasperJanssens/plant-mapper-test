...
(* OASIS_START *)
(* DO NOT EDIT (digest: 902790c22cf9fe8c2ff638be1874f4fe) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "plant_mapper_test.ml"
                   })
            ];
               ...
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("$ocamlfind",
                           ["install"; "plant_mapper_test"; "lib/META"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          uninstall_custom =
            {
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("$ocamlfind", ["remove"; "plant_mapper_test"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          clean_custom =
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "Mz\226{\190\229\168\174\128\002\166%\150\208\201-";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
